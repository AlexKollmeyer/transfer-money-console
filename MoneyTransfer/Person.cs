...
namespace MoneyTransfer
{
    internal class Person
    {
        ...
        public void DisplayInfo()
        {
            ...
            Console.WriteLine($"{name} has {this.wallet.money} dollars in their wallet");
        }
        ...
        public void AcceptMoney(int amount)
        {
            ...
            this.wallet.money = this.wallet.money += amount;
        }

        public void TransferMoney(Person receiver, int amountToTransfer)
        {
            ...
            else
            {
                ...
                receiver.wallet.money += amountToTransfer;
